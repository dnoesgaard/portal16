...
function routerConfig($stateProvider, $locationProvider, BUILD_VERSION, LOCALE) {
    ...
    $stateProvider
        ...
        .state('occurrenceSearch', {
            ...
            url: '/occurrence?q&basis_of_record&catalog_number&collection_code&continent&country&dataset_key&decimal_latitude&decimal_longitude&depth&elevation&event_date&has_coordinate&has_geospatial_issue&institution_code&issue&last_interpreted&media_type&month&occurrence_id&publishing_country&publishing_org&recorded_by&recorded_by_id&identified_by_id&record_number&scientific_name&taxon_key&kingdom_key&phylum_key&class_key&order_key&family_key&genus_key&sub_genus_key&species_key&year&establishment_means&type_status&organism_id&locality&water_body&state_province&protocol&license&repatriated&{advanced:bool}&geometry&event_id&parent_event_id&sampling_protocol&installation_key&network_key&programme&project_id&verbatim_scientific_name&taxon_id&organism_quantity&organism_quantity_type&sample_size_unit&sample_size_value&relative_organism_quantity&institution_key&collection_key&coordinateUncertaintyInMeters&occurrence_status',
            params: {
                advanced: {
                    value: false,
                    squash: true
